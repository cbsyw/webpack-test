...
eval("\n\nmodule.exports = function (url, options) {\n  if (!options) {\n    options = {};\n  }\n  if (!url) {\n    return url;\n  }\n  url = String(url.__esModule ? url.default : url);\n\n  // If url is already wrapped in quotes, remove them\n  if (/^['\"].*['\"]$/.test(url)) {\n    url = url.slice(1, -1);\n  }\n  if (options.hash) {\n    url += options.hash;\n  }\n\n  // Should url be wrapped?\n  // See https://drafts.csswg.org/css-values-3/#urls\n  if (/[\"'() \\t\\n]|(%20)/.test(url) || options.needQuotes) {\n    return \"\\\"\".concat(url.replace(/\"/g, '\\\\\"').replace(/\\n/g, \"\\\\n\"), \"\\\"\");\n  }\n  return url;\n};\n\n//# sourceURL=webpack://resypage/./node_modules/css-loader/dist/runtime/getUrl.js?");
...
eval("\n\nmodule.exports = function (i) {\n  return i[1];\n};\n\n//# sourceURL=webpack://resypage/./node_modules/css-loader/dist/runtime/noSourceMaps.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction insertStyleElement(options) {\n  var element = document.createElement(\"style\");\n  options.setAttributes(element, options.attributes);\n  options.insert(element, options.options);\n  return element;\n}\nmodule.exports = insertStyleElement;\n\n//# sourceURL=webpack://resypage/./node_modules/style-loader/dist/runtime/insertStyleElement.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction setAttributesWithoutAttributes(styleElement) {\n  var nonce =  true ? __webpack_require__.nc : 0;\n  if (nonce) {\n    styleElement.setAttribute(\"nonce\", nonce);\n  }\n}\nmodule.exports = setAttributesWithoutAttributes;\n\n//# sourceURL=webpack://resypage/./node_modules/style-loader/dist/runtime/setAttributesWithoutAttributes.js?");
...
eval("\n\n/* istanbul ignore next  */\nfunction styleTagTransform(css, styleElement) {\n  if (styleElement.styleSheet) {\n    styleElement.styleSheet.cssText = css;\n  } else {\n    while (styleElement.firstChild) {\n      styleElement.removeChild(styleElement.firstChild);\n    }\n    styleElement.appendChild(document.createTextNode(css));\n  }\n}\nmodule.exports = styleTagTransform;\n\n//# sourceURL=webpack://resypage/./node_modules/style-loader/dist/runtime/styleTagTransform.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _css_styles_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../css/styles.css */ \"./css/styles.css\");\n/* harmony import */ var _assets_lotusCafe_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../assets/lotusCafe.png */ \"./assets/lotusCafe.png\");\n/* harmony import */ var _functions_handleHome__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../functions/handleHome */ \"./functions/handleHome.js\");\n/* harmony import */ var _functions_handleMenu__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../functions/handleMenu */ \"./functions/handleMenu.js\");\n/* harmony import */ var _functions_handleAbout__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../functions/handleAbout */ \"./functions/handleAbout.js\");\nconsole.log('test');\n\n\n\n\n\n\n\n\nconst menuButton = document.querySelector('.menu')\nconst aboutButton = document.querySelector('.about')\nconst homeButton = document.querySelector('.home')\n\nfunction clearDiv(){\n    const content = document.querySelector('.content')\n    content.innerHTML = ''\n}\n\nfunction init() {\n    // Query for the buttons\n    const menuButton = document.querySelector('.menu');\n    const aboutButton = document.querySelector('.about');\n    const homeButton = document.querySelector('.home');\n    const content = document.querySelector('.content')\n\n\n    if (menuButton) {\n        menuButton.addEventListener('click', clearDiv);\n        menuButton.addEventListener('click', _functions_handleMenu__WEBPACK_IMPORTED_MODULE_3__.handleMenu);\n    } else {\n        console.error(\"Button with class 'menu' not found.\");\n    }\n\n    if (homeButton) {\n        homeButton.addEventListener('click', clearDiv);\n        homeButton.addEventListener('click', _functions_handleHome__WEBPACK_IMPORTED_MODULE_2__.handleHome);\n    } else {\n        console.error(\"Button with class 'home' not found.\");\n    }\n\n    if (aboutButton) {\n        aboutButton.addEventListener('click', clearDiv);\n        aboutButton.addEventListener('click', _functions_handleAbout__WEBPACK_IMPORTED_MODULE_4__.handleAbout);\n    } else {\n        console.error(\"Button with class 'about' not found.\");\n    }\n}\n\n// function init(){\n// menuButton.addEventListener('click',handleMenu)\n// homeButton.addEventListener('click',handleHome)\n// }\n\ninit();\n(0,_functions_handleHome__WEBPACK_IMPORTED_MODULE_2__.handleHome)();\n\n\n//# sourceURL=webpack://resypage/./src/index.js?");

/***/ }),

/***/ "./assets/lotusCafe.png":
/*!******************************!*\
  !*** ./assets/lotusCafe.png ***!
  \******************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

eval("module.exports = __webpack_require__.p + \"5cc7055dbed4617a064e.png\";\n\n//# sourceURL=webpack://resypage/./assets/lotusCafe.png?");
